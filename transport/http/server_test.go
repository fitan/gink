...
import (
	"context"
	"errors"
	httptransport "github.com/fitan/gink/transport/http"
...
func TestServerBadDecode(t *testing.T) {
	handler := httptransport.NewServer(
		...
		func(context.Context, *gin.Context) (interface{}, error) { return struct{}{}, errors.New("dang") },
...
func TestServerBadEncode(t *testing.T) {
	handler := httptransport.NewServer(
		func(context.Context, interface{}) (interface{}, error) { return struct{}{}, nil },
		func(context.Context, *gin.Context) (interface{}, error) { return struct{}{}, nil },
		func(context.Context, *gin.Context, interface{}) error { return errors.New("dang") },
	)
	r := gin.New()
	r.GET("/", handler.ServeHTTP)
	server := httptest.NewServer(r)
...
func TestServerErrorEncoder(t *testing.T) {
	...
	handler := httptransport.NewServer(
		...
		func(context.Context, *gin.Context) (interface{}, error) { return struct{}{}, nil },
		func(context.Context, *gin.Context, interface{}) error { return nil },
		httptransport.ServerErrorEncoder(func(_ context.Context, err error, w *gin.Context) { w.Writer.WriteHeader(code(err)) }),
	)
	r := gin.New()
	r.GET("/", handler.ServeHTTP)
	server := httptest.NewServer(r)
...
func TestMultipleServerBefore(t *testing.T) {
	...
	handler := httptransport.NewServer(
		endpoint.Nop,
		func(context.Context, *gin.Context) (interface{}, error) {
			return struct{}{}, nil
		},
		func(_ context.Context, w *gin.Context, _ interface{}) error {
			w.Header(headerKey, headerVal)
			w.Writer.WriteHeader(statusCode)
			w.Writer.Write([]byte(responseBody))
			return nil
		},
		httptransport.ServerBefore(func(ctx context.Context, r *gin.Context) context.Context {
...
func TestMultipleServerAfter(t *testing.T) {
	...
	handler := httptransport.NewServer(
		...
		httptransport.ServerAfter(func(ctx context.Context, w *gin.Context) context.Context {
			ctx = context.WithValue(ctx, "one", 1)
...
func TestServerFinalizer(t *testing.T) {
	...
	handler := httptransport.NewServer(
		...
		httptransport.ServerFinalizer(func(ctx context.Context, code int, _ *gin.Context) {
...
// gin header is set, can not repeat
...
func TestEnhancedError(t *testing.T) {
	handler := httptransport.NewServer(
		...
		func(context.Context, *gin.Context) (interface{}, error) { return struct{}{}, nil },
		func(_ context.Context, w *gin.Context, _ interface{}) error { return nil },
	)
...
func testServer(t *testing.T) (step func(), resp <-chan *http.Response) {
	var (
		...
		handler  = httptransport.NewServer(
			...
			func(context.Context, *gin.Context) (interface{}, error) { return struct{}{}, nil },
			func(context.Context, *gin.Context, interface{}) error { return nil },
			httptransport.ServerBefore(func(ctx context.Context, r *gin.Context) context.Context { return ctx }),
			httptransport.ServerAfter(func(ctx context.Context, w *gin.Context) context.Context { return ctx }),
		)
	)
	go func() {
		r := gin.New()
